...
struct MockDeviceCardView: View {
  ...
  var body: some View {
    ...
    .alert("Sightread Required", isPresented: $viewModel.showCameraPermissionAlert) {
      Button("Open Settings") {
        viewModel.openSettings()
      }
      Button("Cancel", role: .cancel) {}
    } message: {
      Text("Sightread was denied. Please enable it in Settings to use the camera source.")
    }
  }
}
