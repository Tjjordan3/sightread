...
// SightreadApp.swift
//
// Main entry point for the Sightread sample app demonstrating the Meta Wearables DAT SDK.
...
struct SightreadApp: App {
  ...
  init() {
    do {
      ...
      #if DEBUG
      NSLog("[Sightread] Failed to configure Wearables SDK: \(error)")
      #endif
    }
